...
\linhalayout{coordenação da coleção}{Daniel Douek, Michel Gherman e Rafael Kruchin}
\linhalayout{título original}{\textit{Yitzhak Rabin: soldier, leader, statesman} (2017)}
...
\titulagem
\bigskip
{\Formular\bfseries\Large \autor \par\vspace{2.5em}}
% \ifdef{\organizador}{{\small {\organizador} (\textit{organização})} \par}{}
...
\ifdef{\prefacio}{{\small {\prefacio} (\textit{prefácio})}\par}{}\vspace{3.5em}
