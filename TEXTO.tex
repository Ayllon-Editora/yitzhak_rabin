\part[Yitzhak Rabin: uma biografia]{Yitzhak Rabin:\break uma biografia}
...
% \begin{epigraphs} 
% \qitem{{\itshape Yitzhak Rabin não era um homem carismático, mas sim um capitão lógico e capaz. Ele não havia sido brindado com a paixão poética de Ben"-Gurion, nem com a cálida graciosidade de Levi Eshkol. Ele não tinha a simplicidade arrebatadora de Golda Meir, nem a energia populista de Menachem Begin. A multidão nunca respondeu a ele cantando \textit{Rabin, Rabin}. Comportando"-se como um engenheiro cuidadoso e um navegador preciso, sua personalidade incorporava o espírito de uma nova Israel, um país que buscava não a redenção, mas soluções.}}{\textsc{amos oz, 1996}}
% \end{epigraphs} 

%\chapter[Prólogo]{Prólogo\subtitulo{A morte de Yitzhak Rabin,\\ a vida de Yitzhak Rabin}}
\chapter*{Prólogo\smallskip\subtitulo{A morte de Yitzhak Rabin,\break a vida de Yitzhak Rabin}}\addcontentsline{toc}{chapter}{Prólogo}
...
\textls[10]{Na sequência do assassinato de Yitzhak Rabin em 1995, um público
...
a Frente de Libertação Nacional (\textsc{fln}).}\looseness=-1\footnote{Michael Karpin e Ina Friedman, \textit{Assassinato em nome de Deus: o plano para matar
Yitzhak Rabin}. Tel Aviv: Zemorá"-Bitan, 1999, p. 40 {[}em hebraico{]}.} \textls[10]{Se tivessem sido bem"-sucedidos,
...
valiosa parte do território nacional.}\looseness=-1
...
\textls[-5]{O homicídio de Rabin também ressaltou o forte contraste entre o
...
com a Síria e com os palestinos e pela elevada qualidade de sua liderança.}\looseness=-1
...
\chapter*{A criação de um soldado\smallskip\subtitulo{1922--48}}\addcontentsline{toc}{chapter}{A criação de um soldado}

\textls[-5]{``Com exceção de sua inteligência e tenacidade, Rabin não tinha nada para ser
...
ir ao amago do problema, eram incríveis.''}\looseness=-1\footnote{Henry Kissinger, \textit{White House Years} {[}Anos na Casa Branca{]}, vol.\,1. Boston: Little,
Brown and Company, 1979, p.\,55.} \textls[-5]{Foi assim que Henry Kissinger hábil e sutilmente descreveu Yitzhak
...
político esquisito em um estadista impressionante.}\looseness=-1
...
\textls[5]{Ao chegar a Jerusalém, Rosa foi apresentada por seu primo David Hacohen
...
e seu círculo social e não mais os tolera''.}\looseness=-1\footnote{Carta de Sharett à sua irmã, sem data. Coleção privada.}
...
\textls[-15]{Durante sua última estada com seus parentes em Jerusalém, Rabin enviou
 ...
 personalidade. Em 6 de agosto de 1937 escreveu:}\looseness=-1
...
\textls[-5]{Rabin foi enviado ao primeiro curso de comandantes de esquadrão do
...
considerado nada especial''.}\looseness=-1\footnote{Testemunho de Mickey Haft, sem data. Museu do Palmach.}
...
\textls[10]{Em 29 de junho de 1946, data conhecida na história israelense como o Sábado
...
registrou seu primeiro encontro com Rabin em Rafah:}\looseness=-1
...
\textls[5]{Rabin não ficou muito tempo no posto de comandante de batalhão. Alon,
...
de Rabin foi enviada a Jerusalém para participar da batalha pela cidade.}\looseness=-1
...
\textls[-10]{A Guerra de Independência durou mais de um ano e foi um esforço caro e
...
homens engajaram"-se em algumas das mais ferozes batalhas da guerra.}\looseness=-1
...
\textls[-10]{Um dos dois comandantes de batalhão de Rabin, Yosef (Yosef'le) Tabenkin
...
recusava"-se a aceitar sua autoridade.}\looseness=-1\footnote{Esses testemunhos estão nos arquivos do Museu do Palmach.} \textls[-10]{Rabin e Tabenkin haviam
...
maior parte possível de Jerusalém.}\looseness=-1
...
\textls[-10]{Às vésperas da primeira trégua, em 11 de junho de 1948, Alon renomeou
...
missão de garantir o acesso a Jerusalém.}\looseness=-1\footnote{David Daniel Marcus 
...
Gigante{]}, no qual Kirk Douglas atuou no papel de Marcus.} \textls[-10]{O objetivo era controlar
posições"-chave mais distantes, como a cidade palestina de Ramallah e a
fortaleza de Latrun.}\looseness=-1
...
\textls[-15]{Quando o coronel Stone foi morto em um trágico acidente por um soldado
...
duas questões políticas complicadas, ambas envolvendo Rabin.}\looseness=-1
...
\textls[-15]{O episódio do \textit{Altalena} se manteria como um ponto controverso de
...
de pecados de Rabin.}\looseness=-1
...
\textls[10]{Rabin acreditava que a importância do episódio residia no aumento da
...
em 1948 e nos anos seguintes.}\looseness=-1

\textls[10]{Quando os combates recomeçaram após o final da primeira trégua em 11 de
...
escala dos civis árabes.}\looseness=-1

\textls[-5]{A questão da expulsão marca o debate político e historiográfico
...
imprensa internacional:}\looseness=-1
...
\textls[-5]{A segunda parte da Operação Danny fracassou: tanto Latrun quanto
...
descrito pela biógrafa de Alon,}\looseness=-1
...
\textls[-5]{Rabin aproveitou o intervalo no conflito para casar"-se com sua namorada
...
\textls[-17]{Quatro brigadas foram destinadas à frente sul. Alon era o comandante e
...
sua implementação.}\looseness=-1

\textls[-10]{Entre outubro de 1948 e março de 1949, as \textsc{idf} completariam três grandes
...
\begin{quote}
\textls[-10]{Estou convencido, por tudo que vi e ouvi aqui, que os egípcios
...
diplomacia.}\looseness=-1\footnote{Carta a Yigal Alon, 10 fev. 1949.}
\end{quote}
...
\chapter*{Da Independência até a\break Guerra dos Seis Dias\smallskip\subtitulo{1949--67}}\addcontentsline{toc}{chapter}{Da Independência até a Guerra dos Seis Dias}
...
\textls[-5]{As tensões em torno do tema chegaram ao auge em 24 de
...
e colegas era outra.}\looseness=-1

\textls[-5]{Ben Gurion ficou revoltado e a conduta de Rabin custou"-lhe uma década de
...
\begin{quote}
\textls[15]{Dori: Você foi convocado para um julgamento disciplinar por quebra de
disciplina. Você recebeu uma ordem proibindo a sua participação na
manifestação?}\looseness=-1
...
\textls[-10]{Rabin: De fato havia uma ordem, mas não há lei que proíba um
soldado de participar de manifestações como cidadão quando está de folga.}\looseness=-1
\end{quote}
...
\textls[-7]{A ascensão de Rabin na lista de promoções das \textsc{idf} foi demonstrada pela
...
iniciativa de Maklef.}\looseness=-1

\textls[-5]{Naquele momento, Rabin e sua família estavam em Camberley, na Inglaterra,
...
Leah e de sua filha Dalia (seu filho Yuval nasceria em 1955).}\looseness=-1

\textls[-5]{Com a volta de Rabin, Dayan, agora chefe do Estado"-Maior,
...
relacionamento pessoal difícil.}\looseness=-1
...
\begin{quote}
\textls[-15]{Ben Gurion ofereceu uma ampla
...
Estado"-Maior, mas a oferta não veio dele.}\looseness=-1\footnote{Rosenthal, \textit{Yitzhak Rabin, primeiro"-ministro de Israel}, \textit{op}. \textit{cit}., p. 265.}
\end{quote}
...
\textls[10]{Foi uma decisão acertada. Na primavera de 1963, Ben Gurion abandonou a
...
Rabin se tornou chefe do Estado"-Maior em janeiro de 1964.}\looseness=-1

\textls[10]{Naquela época, a liderança sênior das \textsc{idf} era composta de um pequeno
...
ser parte de seu universo ainda na década de 1990.}\looseness=-1

\textls[10]{Após constituir seu governo em 26 de junho de 1963, Eshkol teve duas
...
alcançá"-lo sem uma guerra''.}\looseness=-1\footnote{\textit{Ibid}., p. 318--21.}
...
\textls[-7]{O lento avanço de Rabin rumo ao topo da pirâmide das \textsc{idf} teve um
...
agregavam à autoridade que já possuía junto a colegas e subordinados.}\looseness=-1

\textls[10]{Rabin montou um time que até hoje é considerado o melhor comando"-geral
...
\textls[15]{Entre 1949 e 1964, Rabin ocupou diversas posições que tiveram um papel
...
tornasse inevitável.}\looseness=-1
...
\textls[-20]{Entretanto, três cenários se desenvolviam na época e alterariam a
...
nacionalismo palestino; e a radicalização da política síria.}\looseness=-1
...
\textls[-15]{O objetivo da conferência era lidar com a nova ameaça israelense. Nasser
...
população palestina.}\looseness=-1
...
\textls[-15]{A implementação dessas resoluções exacerbou o conflito árabe"-israelense
...
em um ator independente no contexto da política árabe.}\looseness=-1

\textls[-5]{Com a Síria tendo iniciado os trabalhos para o desvio das fontes
...
\textls[15]{Se Nasser esperava que essas concessões servissem para acalmar as
...
engajados no esforço para desviar os tributários do rio Jordão.}\looseness=-1

\textls[15]{Havia uma dimensão jordaniana no processo. Em novembro de 1966, um
...
crise de maio de 1967.}\looseness=-1
...
\textls[10]{Rabin não ameaçou exatamente derrubar o regime Baath, mas sua
...
outros países e seus regimes''.}\looseness=-1

\textls[-15]{Não foi a primeira vez que Eshkol repreendeu Rabin. Em setembro de 1964,
...
iniciativa de fazê"-lo''.}\looseness=-1\footnote{\textit{Ibid}., p. 417.} \textls[-15]{Rabin respeitava a subordinação
...
\textls[-13]{A remilitarização do Sinai, uma clara violação dos acordos de 1957, logo
...
e a guerra parecia iminente, se não inevitável.}\looseness=-1
...
\textls[-18]{O maior defensor de uma solução diplomática era o principal diplomata do
...
eliminar a ameaça egípcia mais ampla.}\looseness=-1
...
\textls[-20]{A sequencia de eventos criou um problema para Rabin. Ele havia
...
se apoiar e com quem compartilhar a responsabilidade.}\looseness=-1
...
\textls[-10]{A versão de Weizman sobre o evento é bem diferente e menos elogiosa de
...
do Estado"-Maior das \textsc{idf} era prerrogativa do gabinete.}\looseness=-1
...
\textls[-5]{Quando Rabin retornou a seu posto, o gabinete ainda não estava pronto
...
próprios canais que o governo Johnson não se opunha à ação israelense.}\looseness=-1
...
\textls[-5]{Apesar do sucesso da guerra, a colaboração e coordenação entre Rabin e
...
muito elogiado por seu discurso de aceitação do título, que dizia:}\looseness=-1
...
\textls[10]{Somente nos anos que se seguiram ficou clara a magnitude dos problemas
...
\chapter*{Embaixador em Washington\smallskip\subtitulo{1968--73}}\addcontentsline{toc}{chapter}{Embaixador em Washington}
%\markboth{Embaixador em Washington}{}

\textls[-10]{O posto de embaixador israelense em Washington, como bem sei, é um posto
...
comunicação com o primeiro"-ministro.}\looseness=-1

\textls[-15]{Yitzhak Rabin foi, sem dúvida, um dos embaixadores israelenses mais
...
ministro das Relações Exteriores.}\looseness=-1
...
\textls[-5]{Rabin precisou de algum tempo para dominar sua nova posição.
...
relação forte e frutífera também com esses grupos.}\looseness=-1

\textls[-5]{A relação de Rabin com a comunidade judaica organizada dos Estados Unidos teve
...
\textit{mutatis mutandis}, parecidas.}\looseness=-1
...
\textls[15]{As diferenças entre as posições israelense e norte"-americana emergiriam
...
tornou"-se a Resolução 242 do Conselho de Segurança.}\looseness=-1
...
\textls[-10]{Quando Jarring iniciou seu ``pinga"-pinga'' diplomático, as hostilidades
...
sobre o país e os Estados Unidos, seu principal apoiador.}\looseness=-1
...
\textls[5]{No final, o documento norte"-americano foi rejeitado pelo Egito, mas os
...
vizinhos''.}\looseness=-1\footnote{Rabin, \textit{The Rabin Memoirs}, \textit{op}. \textit{cit}., p. 139.} 
\textls[5]{Rabin deixou com o secretário um
 ...
 15 de novembro de 1968:}\looseness=-1

\begin{quote}
\textls[5]{Rabin crê que mudamos nossa posição e
...
qualquer chance à paz.}\looseness=-1\footnote{Estados Unidos da América, \textit{Foreign Relations of the United States} 
{[}Relações Exteriores dos Estados Unidos{]}, 1964--1968, documento 322.}
\end{quote}

\textls[-10]{Grande parte da energia de Rabin durante esse período foi gasta tentando
...
Departamento de Estado.}\looseness=-1

\textls[10]{Outro importante esforço de Rabin durante esse período foi feito para
...
de guerra'' com o vice"-ministro da Defesa, o formidável Paul Warnke.}\looseness=-1
...
\textls[10]{A mudança de opinião de Rabin coincidiu com um período de enorme pressão
...
relação com os Estados Unidos''.}\looseness=-1
...
\textls[-10]{Mas Rabin reconhecia que, sofismas aparte, o ``toma lá dá cá'' com os
...
organizado por Rabin entre Nixon e Golda Meir.}\looseness=-1
...
\textls[5]{Kissinger era crítico dessa política. Sua rivalidade com Rogers
...
acordos importantes de suprimentos de armas para Israel.}\looseness=-1
...
\textls[5]{Apesar de não lidar diretamente com a diplomacia do Oriente
...
Rogers --- e o primeiro o descreveu com carinho, mas com um toque de ironia:}\looseness=-1
...
\textls[5]{Com o passar do ano de 1969, o Departamento de Estado ampliou a pressão
...
norte"-americana.}\looseness=-1\footnote{Rabin, \textit{The Rabin Memoirs}, 
\textit{op}. \textit{cit}., p. 164.} \textls[5]{Rabin na verdade gostava de Rogers e o tinha
pessoalmente em alta estima, mas divergia profundamente de sua política
e entendia que seria um erro fatal criticar pessoalmente a Nixon.}\looseness=-1
...
\textls[-10]{Rabin argumentou repetidas vezes que essa não era nem sua impressão nem
...
Rogers e sua política derrotados.}\looseness=-1

\textls[-5]{Rabin acreditava na necessidade de uma intensificação dos ataques contra
...
assessor de Segurança Nacional e do embaixador.}\looseness=-1
...
\textls[-5]{Rabin em nenhum momento foi dissuadido pelas críticas. Continuou a
...
escritório do primeiro"-ministro):}\looseness=-1
...
\textls[10]{Kissinger, que conhecia bem a Rabin e Eban, e trabalhava com os dois,
...
o soldado Sabra (israelense nativo) espinhoso, duro.}\looseness=-1
...
declarações, mas, como você pode ver, sem muito sucesso''.\footnote{\textls[20]{Moshe Bitan, \textit{Diário Político, 1967--1970}. Tel Aviv: Olam Hadash, 2014 {[}em
hebraico{]}.}\looseness=-1}
...
\textls[-10]{A ação de um cliente soviético, ao invadir o território de um protegido
...
estaria disposta a utilizar seu exército para salvar o rei.}\looseness=-1

\textls[-15]{Estava longe de ser uma decisão fácil. Israel necessitava
...
transmitem o clima do drama daqueles dias:}\looseness=-1
...
\textls[-10]{\textsc{rabin}: Enquanto isso, também tenho instruções. Mais
detalhadas.}\looseness=-1\footnote{Estados Unidos da América, \textit{Foreign Relations of the United States}, vol. 24, documento 301.}
\end{quote}
...
\begin{quote}
\textls[15]{O presidente nunca esquecerá o papel de Israel ao impedir a
...
futuro.}\looseness=-1\footnote{Rabin, \textit{The Rabin Memoirs}, \textit{op.\,cit}., p.\,189.}
\end{quote}

\textls[-15]{O risco assumido por Israel pagaria amplos dividendos ao longo dos três
...
o impasse que levaria à Guerra de Outubro.}\looseness=-1
...
\textls[-15]{Desalentado e desapontado, Rabin escreveu uma dura carta a Meir. A carta
não está datada e pode ou não ter sido enviada, mas o texto demonstra o
quanto Rabin estava desanimado e frustrado:}\looseness=-1
...
\chapter*{O primeiro mandato\smallskip\subtitulo{1974--77}}\addcontentsline{toc}{chapter}{O primeiro mandato}
%\markboth{O primeiro mandato}{}

\textls[-5]{Em três de junho de 1974, Yitzhak Rabin foi confirmado pelo Knesset como
...
planejadas para outubro de 1973. Dov Tzamir, um membro do \textit{kibutz} Bror
Hail, localizado no sul do país e representando o Movimento Kibutziano Unificado
...
\textls[-5]{Após a guerra havia chegado a hora do acerto de contas político. A
...
publicado em abril de 1974.}\looseness=-1
...
\textls[-10]{De qualquer forma, o tempo de Rabin como ministro do Trabalho seria
...
renunciar em 11 de abril de 1974.}\looseness=-1
...
\textls[10]{Em suas memórias, os relatos de Rabin sobre os eventos que antecederam
...
que ele sugeriu. Assim que respondi, secamente, Combinado''\,'.}\looseness=-1\footnote{Rabin, \textit{The Rabin Memoirs}, \textit{op}. \textit{cit}., p. 239.}
...
\textls[5]{Enquanto isso, tornava"-se difícil a criação de uma nova coalizão sob o
...
um aliado muito efetivo, leal e útil a Rabin.}\looseness=-1

\textls[-5]{Eram enormes os desafios e as missões à espera de Rabin. Ele precisava
...
israelense, ele teria um enorme impacto na vida e na política de Israel.}\looseness=-1
...
\textls[5]{Teoricamente, Rabin poderia ter decidido encarar de frente essas
...
que acontecia.}\looseness=-1\footnote{Jonathan Shapiro, \textit{Uma elite sem sucessores: gerações de líderes políticos em Israel}. Tel Aviv: Poalim, 1984 {[}em hebraico{]}.}
...
\textls[7]{Mas o principal problema político de Rabin era sua relação com Peres.
...
contaminou ainda mais uma relação que já era ruim.}\looseness=-1
...
\textls[-5]{Rabin e Peres poderiam eventualmente ter superado esses enormes
...
lançou uma sombra permanente sobre o primeiro mandato de Rabin.}\looseness=-1
...
\textls[-10]{Em junho de 1974, Nixon visitou Israel durante um giro pelo Oriente Médio
...
território.}\looseness=-1

\textls[-13]{Rabin avaliou o Plano Jericó mas, no final, rejeitou"-o. Ele apoiava a
...
não era o Rabin do verão de 1974.}\looseness=-1
...
\textls[-5]{O governo Ford buscava reiniciar o processo de paz, negociando novos
...
troca de uma retirada parcial israelense.}\looseness=-1
...
\textls[-5]{A exposição franca gerou uma tormenta de protestos na mídia e por parte
...
mídia e como manipulá"-la.}\looseness=-1
...
\textls[5]{Em 22 de março, tornou"-se óbvio que os esforços de mediação de Kissinger
...
secretário de Estado dos Estados Unidos para engajar"-se numa missão mal"-sucedida.}\looseness=-1
...
\textls[-5]{Levou algum tempo para que os ânimos esfriassem e para o retorno da
...
intuito de completar sua missão.}\looseness=-1
...
\textls[-15]{Vinte anos mais tarde, as manifestações e o incitamento oriundo dos
mesmos grupos seriam dirigidos contra o próprio Rabin.}\looseness=-1

\textls[-10]{Em 31 de agosto, a parcela do acordo relativa a Israel e ao Egito estava
...
chegar a um acordo em 1\textsuperscript{o} de setembro de 1975.}\looseness=-1
...
\textls[-5]{Um dos principais desafios decorrentes da manutenção do \textit{status
...
seria responsável pela administração civil.}\looseness=-1

\textls[-7]{O Gush Emunim persistia em seus esforços para criar assentamentos na
...
futuro acordo com a Jordânia, ou com uma entidade palestina.}\looseness=-1
...
\textls[-5]{O evento de Sebastia foi um ponto de inflexão em vários aspectos. Foi um
...
de então, foi difícil deter o desgaste de suas relações.}\looseness=-1

\textls[-5]{A irritação de Rabin com Peres explodiria poucas semanas depois, em
...
mais que supérfluos, quase ridículos''.}\looseness=-1\footnote{Rabin,
\textit{The Rabin Memoirs}, \textit{op}. \textit{cit}., p. 277.} \textls[-5]{Seus comentários
...
não o conteúdo de seus comentários.}\looseness=-1
...
\textls[10]{Quase uma década depois de junho de 1967 e do início do controle
...
militar, com o objetivo de liberar os reféns.}\looseness=-1
...
\textls[-3]{Foi somente na sexta"-feira, 2 de julho, em um encontro no escritório do
...
Shomron, que depois viria a ser chefe do Estado"-Maior das \textsc{idf}.}\looseness=-1

\textls[5]{Em resumo, a operação Entebbe foi um grande sucesso. Uma operação
...
amenidades.}\looseness=-1

\textls[5]{O sucesso da operação também provocou uma ``guerra suja'' entre aqueles
...
libertar os reféns''.}\looseness=-1\footnote{Rabin, \textit{The Rabin Memoirs},
\textit{op}. \textit{cit}., p. 284.} \textls[5]{Em condições normais, as duas
...
\textls[-5]{Em fevereiro de 1975, Michael Tzur, ex"-diretor"-geral do Ministério da
...
funcionava da maneira apropriada. E havia mais por vir.}\looseness=-1
...
\textls[-10]{Foi nesse contexto que Dan Margalit, o correspondente em Washington do
...
para o Knesset.}\looseness=-1

\textls[-10]{O segundo evento importante na derrocada do Partido Trabalhista foi a
...
\textls[-10]{Carter, Rabin e ambos os times reuniram"-se por mais uma hora na manhã
...
\textls[10]{A visita de Rabin aos Estados Unidos ocorreu enquanto ele era o primeiro"-ministro
...
\chapter*{Queda e ascensão\smallskip\subtitulo{1977--92}}\addcontentsline{toc}{chapter}{Queda e ascensão}
...
\textls[10]{Porém, tudo isso parecia muito distante em maio de 1977. Considerando os
...
eleitoral de maio de 1977.}\looseness=-1

\textls[5]{Na sequência dessa derrota, Rabin tomou duas decisões importantes:
...
partidárias.}\looseness=-1

\textls[-5]{Esse padrão foi temporariamente rompido em agosto de 1979, com a
...
o porta"-voz do partido, Yossi Beilin.}\looseness=-1

\textls[-5]{Em novembro de 1980, Rabin enfrentou outro momento difícil. Em 1979,
...
humilhante, contabilizando menos de 30\% dos votos.}\looseness=-1
...
\textls[-5]{Como membro sênior do partido de oposição, Rabin precisava responder às
...
transformou em livro.}\looseness=-1

\textls[5]{A política adotada por Rabin na crise do Líbano de 1976
...
contra a Síria. Em agosto de 1981, ele fez um alerta importante:}\looseness=-1
...
\textls[5]{Em 5 de junho de 1982, o governo Begin fez justamente o contrário do
...
\textls[7]{Ainda que Rabin e o Partido Trabalhista fossem críticos em relação à
...
em Israel e no exterior.}\looseness=-1

\section{Ministro da Defesa, 1984--1990}

\textls[6]{Em 1983, já estava claro que a aventura israelense no Líbano era um
...
aura de paz com o Egito.}\looseness=-1
...
\textls[5]{O terceiro fracasso na tentativa de vencer uma eleição deixou claro que
...
com Shimon, e o partido está apaziguado''.}\looseness=-1\footnote{Yitzhak Navon,
  \textit{Todo o caminho: uma autobiografia}. Jerusalém: Keter, 2015, p. 384
  {[}em hebraico{]}.}

\textls[5]{Para encerrar o impasse entre o Likud e o Partido Trabalhista produzido
...
bastante boa.}\looseness=-1

\textls[15]{O clube dos primeiros"-ministros teve de enfrentar dois escândalos que
...
\textls[5]{O esforço inicial de Rabin para arrumar a casa tinha por objetivo chegar
...
\textls[5]{Os acontecimentos desencadeados pela Primeira Intifada (ou levante
...
por esse erro de julgamento.}\looseness=-1

\textls[10]{De volta a Israel, sua resposta inicial mais uma vez comprovou a
...
excessivo da força.}\looseness=-1\footnote{Amnon Strashnov, \textit{Justiça sob fogo cerrado}.
  Tel Aviv: Yedi'ot Achronot Books, 2004 {[}em hebraico{]}.} \textls[10]{Porém, mesmo
  ...
  foram levados a julgamento.}\looseness=-1

\textls[10]{Em poucas semanas, Rabin compreendeu que a Intifada era impulsionada por
...
abordagens diferentes e possivelmente novas políticas.}\looseness=-1

\textls[-10]{Um exemplo dessa necessidade de implementar mudanças urgentes foi uma
...
negociações de Camp David.}\looseness=-1
...
\textls[5]{O principal esforço de Peres voltado à paz foi investido em Hussein. Nos
...
breve documento que ficou conhecido como Acordo de Londres.}\looseness=-1
...
\textls[10]{Num discurso proferido por Rabin em 26 de março de 1989, fica clara sua
...
\textls[5]{Sob dois aspectos, os eventos de março de 1990 provaram ser um momento
...
e Baker estavam minando a reputação de Shamir dentro de Israel.}\looseness=-1
...
\textls[10]{Embora tenha sido fundamental, a virada em si não garantiu Rabin como
...
do Partido Trabalhista ao cargo de primeiro"-ministro.}\looseness=-1
...
\textls[5]{Apesar de todas essas vantagens, ele quase perdeu a disputa. Sua lista
...
políticas limitadas.}\looseness=-1

\textls[5]{Nesse segundo mandato, sua relação com Peres mudou para melhor, embora
...
\chapter*{A política de paz de Rabin\smallskip\subtitulo{1992--95}}\addcontentsline{toc}{chapter}{A política de paz de Rabin}
...
\textls[-5]{No passado, Rabin não tinha se destacado como grande orador, mas em seu
...
\textls[-5]{Em março de 1993, Rabin foi a Washington para sua primeira reunião de
...
tamanho, mas eu já sabia que estava diante de um gigante''.}\looseness=-1\footnote{Citado
...
\textls[5]{Rabin depois mencionou que teria de submeter o acordo com a Síria a um
...
hachemita na Jordânia''.}\looseness=-1
...
\textls[15]{Em junho de 1998, Singer publicou no jornal \textit{Haaretz} um artigo no
...
negociações foram conduzidas:}\looseness=-1
...
\textls[5]{Rabin continuou mantendo segredo sobre o canal de Oslo, inclusive com
...
sujeito ao aval de Washington.}\looseness=-1
...
\textls[10]{Rabin e Christopher debateram essas questões por um tempo, esclarecendo
...
incluídos.}\looseness=-1\footnote{Rabinovich, \textit{The Brink of Peace}, \textit{op}.
\textit{cit}., p. 104--8.}
...
\textls[-5]{A partir dos relatos de Christopher e Ross, Rabin concluiu que sua
...
Unidos para as férias de verão. A opção síria continuava valendo?}\looseness=-1
...
\textls[-5]{A principal negociação, conduzida entre Shahak e Shaath em Taba, no
...
em direção à paz com Israel.}\looseness=-1
...
\textls[-5]{Entretanto, Peres, que teve uma ótima conduta durante a reunião com o rei,
...
Halevi e Rubinstein.}\looseness=-1
...
\textls[-5]{Depois da solenidade, Clinton seguiu para Amã e Damasco. A viagem para
...
visita de Clinton a Damasco.}\looseness=-1

\textls[10]{Naquelas semanas, continuou havendo progresso em outras frentes. Em
...
as linhas de 4 de junho.}\looseness=-1

\textls[-5]{Rabin se atormentou com esse dilema por várias semanas. As linhas de 4
...
terminaria seu mandato como chefe do Estado"-Maior das \textsc{idf} em dezembro.}\looseness=-1
...
\textls[-5]{A frente síria, por sua vez, chegava a um beco sem saída. Depois da
...
sobre nós mesmos''.}\looseness=-1

\textls[5]{As críticas de Assad eram compartilhadas por proeminentes intelectuais
...
egípcio insistia na obrigatoriedade da inclusão de Israel no tratado.}\looseness=-1
...
\begin{quote}
\textls[-5]{Nós enxergamos a solução permanente no seguinte contexto: o Estado de
...
Seis Dias. Nós não retornaremos às linhas de 4 de junho de 1967.}\looseness=-1
\end{quote}
...
\chapter*{Política, politicagem, incitação\break e assassinato\smallskip\subtitulo{1992--95}}\addcontentsline{toc}{chapter}{Política, politicagem, incitação e assassinato}
...
\textls[-10]{Muito mais ameaçadora foi a agitação provocada pelos colonos da
...
\textls[-5]{É impossível separar o processo de Oslo da complexa relação entre Rabin
...
que se desenhava, manifestado pela assinatura de Oslo \textsc{ii}.}\looseness=-1

\section{Políticas domésticas}

\textls[-15]{O segundo mandato de Rabin, entre 1992 e 1995, é e será lembrado
...
central no desenvolvimento da indústria israelense de alta tecnologia.}\looseness=-1
...
\textls[-15]{O ministro das Finanças de Rabin, Avraham (Baiga) Shochat, era um
...
economia israelense à economia global.}\looseness=-1
...
\textls[-5]{A oposição ao governo de Rabin em 1993 era liderada por Benjamin
...
uma negação plausível dessas posições.}\looseness=-1

\textls[-5]{Era óbvio nessa etapa que o governo e a oposição estavam em rota de
...
esforços para manter o diálogo foram abandonados.}\looseness=-1
...
\textls[-5]{Em janeiro de 1995, uma carta foi enviada do assentamento de Har Bracha,
...
alertou: ``Vocês estão brincando com fogo''.}\looseness=-1\footnote{Karpin \& Friedman, 
...
\textls[15]{Amir decidiu matar Rabin em setembro de 1993, após assistir à cerimônia
...
tiros nas costas de Rabin --- que estava praticamente desprotegido.}\looseness=-1
...
\textls[-5]{A sequencia de trágicos eventos cobrou um alto preço político. Peres,
...
começou a se afastar do caminho trilhado por Rabin.}\looseness=-1

\chapter*{Epílogo}
\addcontentsline{toc}{chapter}{Epílogo\medskip}
...
\textls[-5]{Apesar disso, pode-se dizer que Amir realmente infligiu um pesado
...
e os palestinos ainda estão presos ao conflito.}\looseness=-1
...
\textls[-5]{Quando presidentes e primeiros"-ministros de Israel falecem, eles são
...
homenageando Rabin.}\looseness=-1
...
\textls[-5]{Lidar com a memória de Rabin no sistema educacional israelense tem sido
...
detratores.}\looseness=-1

\textls[-5]{Ainda assim está claro que, ao longo de mais de vinte anos, a veneração
...
forças do Irgun na Terra de Israel''.}\looseness=-1\footnote{Citado por Amnon Barzilai 
em \emph{Haaretz}, 14 jun. 2013.} \textls[-5]{O fracasso do sionismo
...
\textls[10]{Em algum momento, considerei como um sub-título para esse livro uma linha
...
fachada rude escondendo uma sensibilidade interior.}\looseness=-1
...
\textls[15]{Minha pesquisa foi facilitada por três membros da família Rabin: 
...
quais sou extremamente grato:}\looseness=-1

\textls[-10]{Sr.\,Uri Avneri, gen.\,Yaacov Amidror, sr.\,Uzi Baram, sr.\,Nachum Barnea,
dr.\,Michael Bar"-Zohar, dr.\,Yossi Beilin, prof.\,Haim Ben"-Shahar, gen.\,Amos Chorev, sr.\,Eitan Haber, dr.\,Yair Hirschfeld, sr.\,Amos Eran, dr.\,Oded Eran, gen.\,Shlomo Gazit, prof.\,Moti Golani, sr.\,Haim Guri, dr.\,Martin Indyk, sr.\,Chezi Kalo, dr.\,Igal Kipnis, sra. Niva Lanir, sr.\,Dani
...
sr.\,Zvi Rafiah, embaixador Dennis Ross, o finado sr.\,Yossi Sarid, sr.\,Uri Savir, o juiz Meir Shamgar, sr.\,Shimon Sheves, sra.\,Ora Teveth, o finado sr.\,Dov Tzamir, dr.\,Hagai Tzoreff, e o sr.\,Dov Weissglas.}\looseness=-1
