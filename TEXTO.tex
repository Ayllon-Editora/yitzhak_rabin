...
%He was not endowed with
%
%Ben Gurion's prophetic passion, nor with Levi
%
%Eshkol's warm gracefulness. He did not have Golda
%
%Meir's sweeping simplicity, nor Menachem Begin's
%
%populist energy. The crowd never responded to him
%
%by chanting ``Rabin, Rabin.'' By being a careful
%
%engineer and a precise navigator, his personality
%
%embodied the spirit of new Israel, a country seeking
%
%not redemption but solutions.
%
%---Amos Oz, 1996
...
a Frente de Libertação Nacional (\versal{fln}).\footnote{Michael Karpin e Ina Friedman, \emph{Assassinato em nome de Deus: o plano para matar
...
\hedramarkboth{A criação de um soldado}{}
...
dezembro de 1919, ela embarcou em Odessa no \versal{SS} Ruslan, um navio
...
O \versal{SS} Ruslan atracou em Yafo em 19 de dezembro de 1919.
...
o Hakibutz Hameuchad, um grupo identificado com a Facção \versal{B} --- um dos
...
líder da Facção \versal{B}, Yitzhak Tabenkin, era considerado um rival de Ben
Gurion (em 1944 a Facção \versal{B} se separaria do Mapai e formaria um novo
...
oficiais do alto escalão das Forças de Defesa de Israel (\versal{IDF}). Rabin participaria em algumas das
...
Partilha da Organização das Nações Unidas (\versal{ONU}) 
...
ocasiões, obstruiu os esforços das \versal{IDF}. Após 15 de maio, a Legião Árabe,
...
exterior auxiliar as \versal{IDF} na Guerra de 1948 e recebeu de Ben Gurion um
...
anteriores das \versal{IDF} para conquistá"-la haviam falhado e sua captura
...
uso das \versal{IDF}. Ambos os oficiais superiores temiam confrontar Ben Gurion
...
das \versal{IDF} que estava de guarda e o confundiu com um invasor, Rabin se
...
Jerusalém e Tel Aviv pertencente ao novo Estado. O comando das \versal{IDF}
...
Uma foi o caso \emph{Altalena}. O \emph{Altalena} era um navio enviado
...
ordenou o bombardeio do navio pela artilharia das \versal{IDF} e o navio foi
...
relação ao Palmach. A liderança das \versal{IDF} queria a nomeação de Alon. Desde
...
\versal{MAPAM}, acrônimo em hebraico de Partido dos Trabalhadores Unidos. O
...
\versal{IDF}, insistiu em nomeá"-lo chefe do Comando Central, vários generais
...
Gurion em relação a ele; sua promoção nas \versal{IDF} foi, portanto, retrasada
...
principais esforços das \versal{IDF} no Comando Central e não no sul, e entregar
o comando da operação a Alon. A operação foi denominada \versal{LRLR} (Lydda ---
...
Qualquer que seja a perspectiva adotada na segunda década do século \versal{XXI},
...
A segunda trégua, após 21 de julho de 1948, foi aproveitada pelas \versal{IDF}
...
implementaram"-se as lições da rodada anterior de confrontos. As \versal{IDF} logo
...
naval para a Ásia e a África. Folke Bernadotte, o mediador da \versal{ONU} que
...
Entre outubro de 1948 e março de 1949, as \versal{IDF} completariam três grandes
...
internacional. Durante as operações Yoav e Chorev, as \versal{IDF} enfrentaram
...
Bunche, o novo mediador da \versal{ONU}. O vice"-comandante das \versal{IDF}, Yigael Yadin,
...
\versal{IDF} foram destituídas da oportunidade de derrotar definitivamente os
...
suas memórias, Rabin sentia que as \versal{IDF} não haviam se preparado
...
\hedramarkboth{Da Independência até a Guerra}{}
...
do Palmach foram expulsos das \versal{IDF}, enquanto outros, em protesto,
...
das \versal{IDF} emitiu uma ordem proibindo oficiais do serviço ativo de
...
Palmach do mais alto escalão nas \versal{IDF}. Sua participação --- ou ausência ---
...
seu ato de rebeldia. Ficar nas \versal{IDF} era uma coisa; lealdade a seus amigos
e colegas era outra.
...
institucionalização das \versal{IDF}. Rabin convidou vários de seus colegas do
Palmach para se juntarem a ele como instrutores. Para alguns, isso representou
um incentivo para ficarem, ou retornarem às \versal{IDF}. Laskov, que havia sido
...
militares, na doutrina específica das \versal{IDF}. Os cinquenta estudantes da
escola se tornariam, ao longo dos anos seguintes, o cerne do comando das
\versal{IDF}, cujos comandantes e alunos desenvolviam, em conjunto, um novo idioma
...
planejamento das \versal{IDF} são um claro exemplo de sua atuação nessa função.
...
metodologia das \versal{IDF} durante esse período foi na realização da transição
do planejamento militar de 1948 para um tipo de planejamento mais
ordenado e sistemático, necessário para as \versal{IDF} do pós"-guerra, ilustrada
por um artigo que escreveu em 24 de dezembro de 1951, intitulado ``Guerra e
Planejamento nas \versal{IDF}''. Rabin estabeleceu a diferença entre planejamento
...
blindados das \versal{IDF}, descreveu Rabin como a ``mais elevada autoridade em
questões militares.''\footnote{Inbar, \emph{Rabin and Israel's National Security}, \emph{op}. \emph{cit}., p. 59.} Outro general das \versal{IDF}, Elad Peled,
escreveu: ``Yitzhak era considerado como o profissional militar mais
graduado pelos representantes da geração de 1948 nas \versal{IDF}. {[}\ldots{}{]} Ele era
...
A ascensão de Rabin na lista de promoções das \versal{IDF} foi demonstrada pela
...
do Ocidente, como parte de uma política designada a proteger as \versal{IDF} do
...
não concordasse. Lavon ainda resistiu, salientando que as \versal{IDF} tinham,
...
espírito das \versal{IDF} e via em Rabin o candidato apropriado para fazer de
...
Na cultura organizacional das \versal{IDF}, era normal que os oficiais servissem
...
militar. Dayan, em seu último ano como chefe do Estado"-Maior das \versal{IDF},
...
reservistas foi mal administrado pelas \versal{IDF}, causando o temor de uma
guerra. Ben Gurion destituiu o chefe da divisão de comando das \versal{IDF} e também o
...
importante nas \versal{IDF} após o chefe do Estado"-Maior Laskov e seu vice Zvi
...
Israel dispunha para a construção das \versal{IDF} em lugar de um dispendioso
...
República Árabe Unida (\versal{RAU}). A escalada das tensões na fronteira
...
outro marco no lento avanço de Rabin ao topo da pirâmide das \versal{IDF}. Ben
...
continuar nas \versal{IDF} em meu posto atual {[}\ldots{}{]} caso se criasse uma relação
...
Naquela época, a liderança sênior das \versal{IDF} era composta de um pequeno
...
importantes reuniões com o comando"-geral das \versal{IDF}, durante as quais
...
\versal{IDF}, disse ele, deveriam esforçar"-se por expandir as fronteiras, mesmo
...
{[}\ldots{}{]} Vemos como funções das \versal{IDF} --- {[}\ldots{}{]} como principal prioridade a defesa do
...
O lento avanço de Rabin rumo ao topo da pirâmide das \versal{IDF} teve um
resultado positivo: ele tornou"-se chefe do Estado"-Maior como o líder
indiscutível, poderoso e legítimo do alto escalão das \versal{IDF}. Rabin era o
mais velho chefe do Estado"-Maior das \versal{IDF} naquela época, e foi o primeiro
oficial a assumir o posto depois de fazer quarenta anos de idade. Tendo servido em várias
funções nas \versal{IDF}, Rabin havia acumulado experiência e profundidade que
...
das \versal{IDF}. Ezer Weizman, Haim Bar"-Lev, Aharon Yariv, Zvi Zamir, Yeshayahu
...
ele então nomeou Sharon como chefe de instrução das \versal{IDF} e o promoveu a
general.
...
importante na construção das \versal{IDF} e na formação de sua doutrina. Ele
continuou, naturalmente, a fazê"-lo como chefe do Estado"-Maior da \versal{IDF}. De
...
Quando Rabin iniciou seu mandato como chefe do Estado"-Maior das \versal{IDF}, em
...
(\versal{OLP}) com o objetivo de criar, pela primeira vez desde 1949, uma
...
formação da \versal{OLP} estava voltada não só contra Israel mas também contra a
...
Unificado, sob o comando de um general egípcio; a \versal{OLP} foi formada,
...
e levou à crise de maio de 1967. A criação da \versal{OLP} estimulou a emergência
...
1964 e 1965, as \versal{IDF}, lideradas e incitadas por Rabin, demonstraram que
...
soldados da \versal{ONU}'' que em 1957 foram estacionados na fronteira com Israel
...
Nasser exigindo a remoção da força de paz da \versal{ONU} e a remilitarização da
Península do Sinai. O argumento de Amer era de que o exército egípcio
poderia conter as \versal{IDF} no Sinai, caso Israel se decidisse pela guerra em
...
das \versal{IDF} às vésperas do ano novo judaico, em setembro de 1966, Rabin
...
encontro do comando geral das \versal{IDF}: ``emiti uma ordem para que todo nosso
...
outro jornal. A atividade de relações públicas das \versal{IDF} continuará,
...
\versal{IDF} que tomassem medidas limitadas de precaução. Hoje sabemos que a ação
...
encorajado, Nasser abandonou a cautela. Exigiu que a \versal{ONU} removesse suas
...
Estreito de Tiran. O secretário"-geral da \versal{ONU}, U Thant,
...
Rabin havia estruturado as \versal{IDF} para lidar com um ataque árabe em várias
...
de que havia levado as \versal{IDF} e o país à beira do abismo. Os generais, por
...
transformado as \versal{IDF} em uma força militar formidável, liderada pelo
...
aéreas árabes em um ataque preemptivo que daria às \versal{IDF} uma vantagem
...
novas realidades do país e da capacidade das \versal{IDF}. O ``Velho'' foi muito
...
\versal{IDF}, que deu a Rabin uma injeção para que dormisse. No dia 25, Rabin
...
do Estado"-Maior das \versal{IDF} era prerrogativa do gabinete.
...
da vitória. Em seis dias, as \versal{IDF} destruíram três forças aéreas árabes e
...
Dayan esteve longe de ser perfeita. Dayan reclamou que as \versal{IDF} chegaram
...
doutorado honorário o vitorioso chefe do Estado"-Maior das \versal{IDF}. Rabin foi
...
\hedramarkboth{Embaixador em Washington}{}
...
Affairs Committee (\versal{AIPAC}) {[}Comitê de Relações Públicas Americano-Israelense{]}, a organização hoje conhecida como o \emph{lobby}
pró"-israelense. A \versal{AIPAC} dos anos 1960, liderada por Isaiah Leo (``Si'')
Kenen, um ativista sionista de origem canadense, estava longe da grande
e poderosa \versal{AIPAC} que, desde os anos 1980, desenvolveu"-se a partir de um
...
evitassem esforços dos blocos árabe, muçulmano e soviético na \versal{ONU}, para
...
produzia frequentes tensões com o embaixador israelense junto à \versal{ONU},
...
Oriente Médio, e com ela aumentava a disposição dos \versal{EUA} para chegar a um
...
profundidade\footnote{A serem realizados contra o Egito. [\versal{N.T.}]} eram particularmente agudas. Eban e seus associados não concordavam com a substância das recomendações de
...
primeiramente várias baterias de misseis antiaéreos (\versal{SAM}) operados por
...
os pilotos russos, mas os mísseis \versal{SAM}-6 demonstraram"-se mortais. Todas
...
mísseis \versal{SAM}-6 em direção ao Canal de Suez. Os Estados Unidos reagiram
...
campanha militar lançada pelo rei Hussein contra a \versal{OLP} em 7 de setembro,
...
brutalidade o exército de Hussein derrotou a \versal{OLP}. A ação levou a Síria,
aliada e protetora da \versal{OLP}, a intervir a seu favor, enviando tanques ao
...
\begin{quote}
\versal{KISSINGER}: Direi a Sisco que fale com você em alguns minutos {[}\ldots{}{]} ele vai
...
\versal{RABIN}: Enquanto isso, também tenho instruções. Mais
...
\item
  ...
  assim os embarques soviéticos para o Vietcong. A posição dos \versal{EUA} em
...
descrição detalhada da conversa que teria com Ismail.\footnote{Documento \versal{NARA}, tornado público em 16 de abril de 2009.}
...
\hedramarkboth{O primeiro mandato}{}
...
(\versal{Takam}, na sigla em hebraico) na sede do Partido
...
militar. O chefe do Estado"-Maior das \versal{IDF} e vários altos oficiais da
...
era Rabin, o chefe do Estado"-Maior das \versal{IDF} responsável pela vitória de
...
\versal{IDF}. A inversão de posições era desconfortável para ambos. Para
...
vice e mais tarde chefe do Estado"-Maior das \versal{IDF}, um caso clássico da
...
O Ministério da Defesa supervisiona as \versal{IDF}, as indústrias de defesa e a
administração dos territórios ocupados em 1967. No sistema israelense
não existe comandante em chefe; o chefe do Estado"-Maior das \versal{IDF} reporta
...
\section{O caminho para Sinai \versal{II}}
...
acordo, também conhecido como Sinai \versal{II}, consolidou as disposições
...
da \versal{OLP}. Dar à Jordânia uma posição na Cisjordânia reforçaria seu papel
...
de Rabin. Sua relação se baseava na inimizade comum com a \versal{OLP} e a Síria
...
manter parte da Cisjordânia, deveria falar com a \versal{OLP}. Em relação a um
...
a Síria e a \versal{OLP}. Suas resoluções reforçaram o reconhecimento da \versal{OLP} como
...
iniciada em setembro ao juntar"-se à Síria, à \versal{OLP} e ao consenso árabe.
...
\versal{ABC} News e entrevistou Rabin. Lindsay perguntou"-lhe o que Israel estava
...
não ameaçar ou recorrer ao uso da força. A força da \versal{ONU} continuaria a
...
Washington comprometeu"-se a não negociar e nem reconhecer a \versal{OLP} até que
...
disse aos representantes árabes na \versal{ONU} que ``Os Estados Unidos
...
da \versal{ONU} no Golã (a Força das Nações Unidas de Observação da Separação, \versal{UNDOF}), deveria ser renovado a cada seis meses. Isso
...
convidar a \versal{OLP} para uma discussão do Conselho de Segurança em janeiro de
...
radicais; com um maior empoderamento da \versal{OLP} em sua fronteira norte; e
...
representava para Israel. A Síria causou duras baixas à \versal{OLP} e sua
preocupação com o Líbano amenizou sua campanha contra o acordo Sinai \versal{II}.
...
haveria como dela escapar. A \versal{OLP} capturou o sul do Líbano e o
...
a Jordânia na Cisjordânia. Ele se opunha veementemente a lidar com a \versal{OLP},
...
com representantes da \versal{OLP}, ainda que contrariando a lei. Durante os
...
Geral da \versal{ONU} denunciando o sionismo como uma forma de racismo, resultado
de uma cooperação árabe"-soviética na \versal{ONU}, com o objetivo de minar a
...
sionismo trabalhista. Motta Gur, chefe do Estado"-Maior das \versal{IDF}, disse
...
confronto, violento e eventualmente sangrento, entre as \versal{IDF} e os
...
permissão para que trinta colonos permanecessem em uma base das \versal{IDF} em
...
as \versal{IDF} atacaram a escola que ocupavam. Já no governo Rabin, em março de
...
de libertação dos terroristas presos. Levou três dias para que as \versal{IDF}
...
primeiro"-ministro em Tel Aviv, que Rabin percebeu que as \versal{IDF} tinham um
...
das \versal{IDF} e comandava um dos grupos de ataque sob o comando geral de Dan
Shomron, que depois viria a ser chefe do Estado"-Maior das \versal{IDF}.
...
que Israel e as \versal{IDF} haviam perdido na Guerra de Outubro. Rabin
...
Estado"-Maior das \versal{IDF}, e um conhecido arqueólogo da Universidade
...
1976, criaram o Movimento Democrático pela Mudança (\versal{DMC}). A eles se
uniram dois apoiadores: Meir Amit, um general aposentado das \versal{IDF} e
...
Likud. O \versal{DMC} oferecia uma alternativa para os eleitores tradicionais dos
...
com a \versal{OLP}; não a um Estado palestino; nenhuma negociação com a Síria, que
...
participação da \versal{OLP}. Ele repreendeu Rabin por deixar de agir ``mais
...
A posição do governo relativa à \versal{OLP} era contraproducente e minava a
tendência do mundo árabe de dar à Jordânia um papel mais preponderante.
Sobre lidar com a \versal{OLP}, Rabin lhe disse: ``você tem sua posição e nós
temos a nossa''.
...
realizar as novas eleições antes que o \versal{DMC} tivesse tempo de se
organizar. Qualquer que tenha sido o cálculo, a ``brilhante manobra''
revelou"-se um tiro pela culatra. O \versal{DMC} se saiu bem nas eleições,
...
do Likud foi amplificada pelo sucesso do \versal{DMC}, que obteve quinze
mandatos. Os trabalhistas ficaram claramente enfraquecidos pela
transferência de parte de seu eleitorado tradicional para o \versal{DMC}. Begin
...
\versal{DMC} na coalizão. Foi a primeira real transferência de poder na política
...
\hedramarkboth{Queda e ascensão}{}
...
pelo governo Begin. O desafio crescente imposto pela \versal{OLP} no sul do
...
Zahlé; o segundo, contra a \versal{OLP}, num duelo de artilharia --- acabaram sem
vencedores. No confronto em torno de Zahlé, os sírios avançaram com seus
mísseis antiaéreos soviéticos, e no duelo de artilharia contra a \versal{OLP} ao
...
falangistas libanesas, destruir a infraestrutura da \versal{OLP} no sul do país e
...
Egito), não estavam avançando, e o duelo de artilharia contra a \versal{OLP} ao
...
fazer recuar os lançadores de foguetes Katyusha da \versal{OLP}, para além de seu
...
consequência, as \versal{IDF} tiveram de abrir caminho para chegar aos arredores
...
então presidente da \versal{OLP}, foi mandado do Líbano para a Tunísia com suas
...
Estado"-Maior, acreditava que, uma vez que as \versal{IDF} entravam num conflito
...
ministro da Defesa e supervisionou a retirada das \versal{IDF} dos arredores de
...
incluindo as nomeações para embaixador em Washington e na \versal{ONU}. Ao
...
necessidade de recuar as \versal{IDF} mais para o sul --- e conseguiu reduzir a
...
acabaram mortos por oficiais do Serviço de Segurança Geral de Israel (\versal{GSS}, no
acrônimo em inglês). Os assassinatos, em si, mas principalmente os esforços
para encobri"-los e os danos provocados ao \versal{GSS} e ao sistema legal
...
dos Estados Unidos, foi preso pelo Departamento Federal de Investigação (\versal{FBI}) por fazer espionagens para
...
Arens, retirou as \versal{IDF} do entorno de Beirute, rumo ao sul, para uma linha
que passava mais ou menos ao longo do rio Awali. Não fazia sentido se
ater àquela linha. As \versal{IDF} estavam sendo fustigadas e atacadas, e Arens e
a liderança das \versal{IDF} não viam sentido em ficar. Porém, Arens não
...
força de manutenção da paz da \versal{ONU}, a \versal{UNIFIL}, criada em 1978, continuaria
sua missão.

A retirada das \versal{IDF} para essa nova linha terminou de ser implementada em
...
independente e precisava do reforço das \versal{IDF}, presentes na zona de
...
das \versal{IDF}, ele comandava os mínimos detalhes do reposicionamento de Israel
...
geral. Quando as \versal{IDF} sofriam baixas no Líbano, Rabin assumia
...
de 1987 surpreendeu Israel, e também a própria liderança da \versal{OLP}. A
princípio, o episódio não foi encarado como marco de uma mudança radical. Em
amplo contraste com os atos terroristas que a \versal{OLP} tinha tentado
...
força. Acusaram"-no de ter dito aos soldados das \versal{IDF} que ``quebrassem os
...
anos. Amnon Strashnov, advogado"-geral das \versal{IDF} naquele momento, descreve
...
gabinete para os comandantes das \versal{IDF} foram claras''. Strashnov questiona
...
israelenses veriam seus filhos, soldados das \versal{IDF}, perseguindo
...
aérea também argumentava que a qualidade dos aviões americanos \versal{F}"-15 e
\versal{F}"-16 era superior, e eles não queriam sacrificar a qualidade em prol do
desenvolvimento tecnológico de Israel. Outros oficiais de alta patente
das \versal{IDF} temiam que os investimentos no projeto levassem a futuros cortes
...
integrantes do baixo escalão da \versal{OLP}, em Túnis. A mensagem era clara: se
...
estou jogando. Conto a Shamir tudo que está acontecendo''.\footnote{Association
  for Diplomatic Studies and Training (\versal{NARA}), entrevista com o embaixador William Brown.}
\end{quote}
...
ser líderes locais da Cisjordânia e da Faixa de Gaza, e não a \versal{OLP}, e que
...
Portanto, nada de negociações com a \versal{OLP} {[}\ldots{}{]} Se as eleições acontecerem
...
\hedramarkboth{A política de paz de Rabin}{}
...
Rabin disse: ``Eu, Yitzhak Rabin, \versal{ID} militar número 30.743,
tenente"-general aposentado, soldado das \versal{IDF} e do exército da paz, eu,
...
1990 fosse conduzido por um ex"-chefe do Estado"-Maior das \versal{IDF} e
...
século \versal{XXI}; na absorção das ondas massivas de imigração oriunda da
...
jordaniano"-palestina. A \versal{OLP}, enfraquecida pela aposta equivocada em
...
incluía ativistas da \versal{OLP}. Além dos canais diretos de negociação, foram
...
recebia instruções de Arafat e da \versal{OLP} em Túnis. A suposta autenticidade
dos palestinos era conveniente, como se Israel não estivesse negociando
com a \versal{OLP}, mas mesmo assim as negociações não deram em nada. Houve certo
...
alternativa islâmica à secular \versal{OLP}. Em 1989, passou a financiar inúmeras
...
encontro da \versal{AIPAC}, o \emph{lobby} israelense em Washington, Clinton assim
...
coragem de agir com independência em relação à \versal{OLP}. Como anexou
...
autonomia com líderes locais, em detrimento da \versal{OLP}; para lidar com a
...
negociação informal com a \versal{OLP} em Oslo, autorizada por ele em fevereiro,
...
A questão da participação da \versal{OLP} foi levantada em outra reunião
...
precisava conversar com a \versal{OLP}. Rabin esboçou um sorriso enigmático.
Poucos naquela sala sabiam que ele já estava negociando de forma
indireta com a \versal{OLP}.
...
de 1990, intensificaram seus ataques contra os soldados das \versal{IDF} que
...
agosto de 1993, com um acordo formal entre Israel e a \versal{OLP}. O processo de
...
israelenses e palestinos; e a disposição da \versal{OLP} em iniciar um processo
de paz com Israel.
...
Alaa''), um dos principais líderes da \versal{OLP}. A reunião aconteceu logo antes
...
Pundak, para uma reunião com Abu Alaa e dois de seus colegasda \versal{OLP}. As
...
importância de tratar com a \versal{OLP}, mesmo que por um canal informal. Também
...
\versal{IDF}, ex"-diretor do Departamento Internacional da Advocacia Geral Militar
...
plena confiança em antigos oficiais das \versal{IDF} e ficou feliz com a
...
o fato em si de terem chegado a um acordo com a \versal{OLP}, o que podia ofuscar seus
...
uma negociação formal com a \versal{OLP}, desde que eu preparasse para sua
...
os representantes da \versal{OLP} em Oslo ficaram chocados quando lhes apresentei
...
quanto à ideia de fazer um acordo com a \versal{OLP} e mantinha suas
...
Ahmad Tibi, político árabe"-israelense muito próximo à liderança da \versal{OLP}.
...
oficial da reserva das \versal{IDF} e político do Partido Trabalhista. Em maio de
...
reconhecimento da \versal{OLP}, condicionado a um prazo de seis meses sem nenhum
...
Declaração de Princípios com Nabil Shaath, alto dirigente da \versal{OLP}. Depois
...
mútuo entre Israel e a \versal{OLP}. O acordo pautava"-se no conceito de autonomia
do final da década de 1970, mas levava"-o muito mais além. Uma Autoridade
Palestina (\versal{AP}) autônoma seria instaurada em Gaza, com um ponto de apoio
...
retornar de Túnis e assumir o controle da nova \versal{AP}. Para Rabin e Peres, o
elemento mais difícil e talvez o mais promissor do acordo era o
reconhecimento mútuo entre ambas as partes e a nova parceria com a \versal{OLP}.
...
acordo, mas os líderes israelenses sabiam que a \versal{OLP} queria o estatuto de
Estado e que uma \versal{AP} totalmente autônoma na Cisjordânia e na Faixa de
...
preocupação com a opinião pública israelense e com a capacidade das \versal{IDF}
...
segurança, e também se preocupava com o desempenho medíocre das \versal{IDF} na
...
(um possível ponto de apoio para a \versal{OLP} na Cisjordânia, para além de
...
era tão radical quanto sua disposição de negociar com a \versal{OLP}. No passado,
...
das \versal{IDF} e chefe do Estado"-Maior nos anos que antecederam a Guerra dos
...
frente significativa --- negociar com a \versal{OLP} ou sair das Colinas do Golã
...
relação entre a \versal{AP} e os assentamentos israelenses na Cisjordânia e na
...
Estado"-Maior das \versal{IDF}, para negociar grande parte dessas questões com
...
postos de controle para entrar e sair da \versal{AP} --- entre duas partes que até
...
a \versal{OLP} e então chegasse à conclusão de que sua melhor escolha era se
...
a \versal{OLP} e precisava dar um tempo para que ele funcionasse e para que o
...
reconhecimento mútuo entre Israel e a \versal{OLP} abriam o caminho para que a
...
grande parte ela vinha se pautando na oposição comum à \versal{OLP}. A segunda
...
controlar a \versal{AP} em Gaza e Jericó. No final de abril, Rabin cumpriu o
...
terminaria seu mandato como chefe do Estado"-Maior das \versal{IDF} em dezembro.
...
Palmach e colegas das \versal{IDF} se juntaram ao movimento. Eles criticavam a
...
As dificuldades com a \versal{AP} e o terrível impacto dos ataques terroristas
...
\versal{II} concentraram"-se na expansão do domínio da \versal{AP} sobre outros territórios
...
criação das áreas \versal{A}, \versal{B} e \versal{C}
na Cisjordânia. A área \versal{A} abrangia as
principais cidades da Cisjordânia; a maior parte da população nessa área
ficaria sob controle total da \versal{AP}. A área \versal{B} ficaria sob controle civil da
\versal{AP}, mas sob controle militar de Israel. Já a área \versal{C}, uma região grande e
...
Oslo \versal{II}. Dentro de Israel, a oposição à assinatura desse acordo atingiu
...
do Estado"-Maior das \versal{IDF}, Amnon Shahak. Correu tudo bem na reunião, mas
...
Israel e a \versal{AP} estavam avançando, o Egito poderia, em tese, tirar da
...
para ratificar Oslo \versal{II}, Rabin fez um discurso importantíssimo, no qual
...
liderança de Arafat, a \versal{OLP} parou de se envolver com o terrorismo, mas a
\versal{AP} precisava fazer muito mais do que vinha fazendo contra esse tipo de
organização.

Rabin descreveu detalhadamente os planos 
para as áreas \versal{A}, \versal{B} e \versal{C}, bem
como o processo de realocação gradual pelas \versal{IDF}. Este seria
dividido por fases, para permitir que Israel verificasse o desempenho da
\versal{AP}. Ele manifestou sua decepção com a \versal{AP}, por não ter conseguido até
...
\hedramarkboth{Política, politicagem\ldots{}}{}
...
\versal{II}. Eles sabiam que a assinatura representaria um importante avanço para
...
que se desenhava, manifestado pela assinatura de Oslo \versal{II}.
...
soldados das \versal{IDF} ao final de seu serviço militar obrigatório). Os
...
O jornalista francês Victor Cygielman escreveu um artigo para o \emph{Le
...
pôsteres vestindo um uniforme da \versal{SS} nazista ou o turbante árabe e
...
câmaras de \versal{TV}, acusou Rabin pela tragédia: ``O primeiro"-ministro optou
...
Em 5 de outubro, o dia da votação no Knesset sobre Oslo \versal{II}, o Likud
...
retratavam Rabin vestido com um uniforme da \versal{SS}. A manifestação naquele
...
uniforme da \versal{SS} foi projetado na parede atrás de onde as pessoas
...
\versal{GSS},  
o \versal{FBI} israelense. Amir se confraternizava com, entre outros, Avishai Raviv, o controverso agente provocador do \versal{GSS}, que operava dentro do
núcleo radical da direita. Ele era o único agente que o \versal{GSS} fora capaz
...
1995, propagaram uma série de teorias da conspiração alegando que o \versal{GSS}
...
Como pôde alguém como Yigal Amir, conhecido do \versal{GSS}, aproximar"-se tanto
...
o chefe da divisão judaica do \versal{GSS} alertou sobre o perigo de uma
...
transformados em ações pela unidade do \versal{GSS} responsável pela segurança
\versal{VIP}. O próprio Rabin se recusou a utilizar um colete à prova de balas,
